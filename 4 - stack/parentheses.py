...
Но перед удалением проверим, не равен ли размер стека нулю. Если равен, то закрывающей скобке
не предшествовала открывающая --> баланса нет.

После завершения цикла проверяем размер стека. Если он больше нуля, то открывающим скобкам
не хватило закрывающих --> баланса нет.
